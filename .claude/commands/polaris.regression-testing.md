...
**Telemetry**: Run: `polaris telemetry record regression-testing --feature <slug> --phase start --agent claude --wp <WP_ID>`
...
**Telemetry**: Run: `polaris telemetry record regression-testing --feature <slug> --phase complete --agent claude --wp <WP_ID>`
