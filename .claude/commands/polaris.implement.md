...
**Telemetry**: Run: `polaris telemetry record implement --feature <slug> --phase start --agent claude --wp <WP_ID>`
...
**Telemetry**: Run: `polaris telemetry record implement --feature <slug> --phase complete --agent claude --wp <WP_ID>`
