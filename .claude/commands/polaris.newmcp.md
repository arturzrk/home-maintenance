...
**Telemetry**: Run: `polaris telemetry record newmcp --feature <slug> --phase start --agent claude`
...
**Telemetry**: Run: `polaris telemetry record newmcp --feature <slug> --phase complete --agent claude`
