...
- MUST NOT create `.polaris/templates/service` in the target repository
...
- MUST NOT copy `.polaris/scripts/github/environments/` into the target repository
...
- `.polaris/templates/service/.github/workflows/`
- `.polaris/templates/service/helm/`
- `.polaris/templates/service/infrastructure/`
- `.polaris/templates/service/config/`
- `.polaris/templates/service/config/MainManifest.example.yml`
- `.polaris/templates/service/config/manifest-schema.json`
- `.polaris/templates/service/manage-appConfig-secrets/`
- `.polaris/templates/service/manage-appConfig-secrets/azureConfig/`
- `.polaris/templates/service/manage-appConfig-secrets/bgmConfig/`
- `.polaris/templates/service/.polaris/scripts/github/environments/`
- `.polaris/templates/service/.polaris/scripts/github/environments/set-env-secrets.ps1`
- `.polaris/templates/service/.polaris/scripts/github/environments/set-env-vars.ps1`

List all `.yml` files found in `.polaris/templates/service/.github/workflows/`.
...
From `<ref-repo>/.polaris/templates/service/.github/workflows/` to `.github/workflows/` in target:
...
From `<ref-repo>/.polaris/templates/service/helm/<ServiceName>/` to `helm/<ServiceName>/`:
- `values-{{ .ServiceName }}.yml`

From `<ref-repo>/.polaris/templates/service/infrastructure/<ServiceName>/` to `infrastructure/<ServiceName>/`:
- `main.tf`
- `variables.tf`
- `versions.tf`

From `<ref-repo>/.polaris/templates/service/manage-appConfig-secrets/` to `manage-appConfig-secrets/`:
...
- If the file does NOT exist:
  * Read `.polaris/templates/service/config/MainManifest.example.yml` from the cloned reference repo
  * Read `.polaris/templates/service/config/manifest-schema.json` from the cloned reference repo
