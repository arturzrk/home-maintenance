...
**Telemetry**: Run: `polaris telemetry record merge --feature <slug> --phase start --agent claude`
...
**Telemetry**: Run: `polaris telemetry record merge --feature <slug> --phase complete --agent claude`
