...
**Telemetry**: Run: `polaris telemetry record report --feature <slug> --phase start --agent claude`
...
**Telemetry**: Run: `polaris telemetry record report --feature <slug> --phase complete --agent claude`
