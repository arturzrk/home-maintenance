...
**Telemetry**: Run: `polaris telemetry record healthcheck --feature <slug> --phase start --agent claude`
...
**Telemetry**: Run: `polaris telemetry record healthcheck --feature <slug> --phase complete --agent claude`
