...
**Telemetry**: Run: `polaris telemetry record qa --feature <slug> --phase start --agent claude`
...
**Telemetry**: Run: `polaris telemetry record qa --feature <slug> --phase complete --agent claude`
