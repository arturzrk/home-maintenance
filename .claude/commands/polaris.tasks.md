...
**Telemetry**: Run: `polaris telemetry record tasks --feature <slug> --phase start --agent claude`
...
**Telemetry**: Run: `polaris telemetry record tasks --feature <slug> --phase complete --agent claude`
