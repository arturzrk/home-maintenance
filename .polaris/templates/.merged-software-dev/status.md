---
description: Display kanban board status showing work package progress across lanes (planned/doing/testing/for_review/done).
---
## Model Guidance
...
```bash
polaris agent tasks status --feature 012-documentation-mission
```

The command displays a rich kanban board with:
- Progress bar showing completion percentage
- Work packages organized by lane (planned/doing/testing/for_review/done)
- Summary metrics
