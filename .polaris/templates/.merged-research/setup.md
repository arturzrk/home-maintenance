...
**Telemetry**: Run: `polaris telemetry record setup --feature <slug> --phase start --agent {{AGENT_NAME}}`
...
**Telemetry**: Run: `polaris telemetry record setup --feature <slug> --phase complete --agent {{AGENT_NAME}}`
