...
**Telemetry**: Run: `polaris telemetry record research --feature <slug> --phase start --agent {{AGENT_NAME}}`
...
**Telemetry**: Run: `polaris telemetry record research --feature <slug> --phase complete --agent {{AGENT_NAME}}`
